...
<h1 class="font-bold text-2xl p-2 m-2">Welcome to Digi-Deck!</h1>
...
<form class="flex flex-col bg-white rounded shadow-lg p-10 mt-7" action="">
    ...
    <button class="flex items-center justify-center h-12 px-6 w-64 bg-Pokeblue mt-8 rounded font-semibold text-sm text-white hover:bg-Pokeliteblue"  onClick={newUserSubmit}>Sign Up</button>
